...
## 🔴 Свежие Исправления (2026-03-19)

### TasteMap: Пустые Бары Жанров на Странице `/profile/taste-map`
**Файл:** [`2026-03-19-taste-map-genre-bars-empty.md`](./2026-03-19-taste-map-genre-bars-empty.md)

**Проблема:** На странице вкусовых предпочтений блок "Ваши жанры" показывал имена жанров и цифры, но бары были полностью пустыми

**Причина:** Языковое рассогласование - API возвращал жанры на русском, UI искал английские названия

**Решение:** Изменить параметр `language=ru-RU` на `language=en-US` в функции `fetchMediaDetails()`

**Затронутые файлы:**
- `src/lib/tmdb.ts` (строка 412) - изменение языкового параметра
