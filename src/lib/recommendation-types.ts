...
/**
 * Union type for filter parameter values
 * Can be primitive types, arrays, or complex objects
 */
export type FilterValue = number | string | boolean | number[] | string[] | Record<string, unknown> | null | undefined;
